...
<body>
	...
	<% out.print("INSERT INTO medical_store (`Name`, `Mobile`, `Address`, `Open_Time`, `Close_Time`, `Date`, `Month`, `Year`) VALUES ('"+F_name+"' , '"+Mobile+"', '"+Address+"', '"+Open_Time+"', '"+Close_Time+"', "+Date+", "+Month+", "+Year+");");%> 
	</sql:update>")   
