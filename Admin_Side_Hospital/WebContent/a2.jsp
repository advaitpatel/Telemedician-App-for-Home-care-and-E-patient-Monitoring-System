				...
				<ul class="nav navbar-right">
					...
					<li class="dropdown current-user"><a data-toggle="dropdown"
						...
						data-close-others="true" href="#"> <img
							src="assets/images/IMG-20141113-WA001(1).jpg" class="circle-img"
							alt=""> <span class="username">Advait Patel</span> <i
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Update Your Records <small>after modifications please
									remember to save changes.</small>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<i class="fa fa-external-link-square"></i> Fill below Details
								Carefully
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square teal"></i> UPDATE HERE
								</h2>
								<p>Please Fill out these details carefully. After this, You
									can not re-modify them again. This Changes will affect to your
									system database.</p>
								<hr>
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<label class="control-label"> Select Actor <span
													class="symbol required"></span> </label> <select
													class="form-control" id="dropdown" name="dropdown">
													<option value="">Choose from here...</option>
													<option value="Category 1">Jr - Admin</option>
													<option value="Category 2">Doctor</option>
													<option value="Category 3">Patient</option>
													<option value="Category 4">Employee - Staff</option>
												</select>
											</div>
											<div class="form-group">
												<label class="control-label"> Enter Name <span
													class="symbol required"></span> </label> <input type="text"
													placeholder="Insert Name" class="form-control"
													id="firstname" name="firstname">
											</div>
											<div class="form-group">
												<label class="control-label"> Enter ID <span
													class="symbol required"></span> </label> <input type="text"
													placeholder="Insert ID" class="form-control" id="lastname"
													name="lastname">
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group connected-group">
												<h5 id="chang">There is an Example which is done for
													you.</h5>
												<div class="form-group">
													<label class="control-label"> Select Actor <span
														class="symbol required"></span> </label> <select
												...
												<div class="form-group">
													<label class="control-label"> Enter Name <span
														class="symbol required"></span> </label> <input type="text"
														placeholder="Advait Patel" class="form-control"
														id="firstname" name="firstname" disabled="disabled">
												</div>
												<div class="form-group">
													<label class="control-label"> Enter ID <span
														class="symbol required"></span> </label> <input type="text"
														placeholder="110410116007" class="form-control"
														id="lastname" name="lastname" disabled="disabled">
												</div>
											</div>
										</div>
										...
										<div class="row" id="side">
											<div class="col-md-8" id="chang">
												<p>By clicking "Save Changes", you are agreeing to the
													Policy and Terms &amp; Conditions.</p>
											</div>
											<div class="col-md-4">

												<button type="submit" class="btn btn-blue btn-lg"
													style="margin-left: -690px; margin-top: 30px;">
													<i class="fa fa-plus"></i> &nbsp;&nbsp;Insert
													Item&nbsp;&nbsp;
												</button>
												<button type="submit" class="btn btn-yellow btn-lg"
													style="margin-left: 40px; margin-top: 30px;">
													<i class="clip-spinner-6"></i> Update Item
												</button>
												<button type="submit" class="btn btn-bricky btn-lg"
													style="margin-left: 40px; margin-top: 30px;">
												...
												<input type="reset" class="btn btn-beige btn-lg"
													value="&nbsp;&nbsp;&nbsp;&nbsp;Try Again&nbsp;&nbsp;&nbsp;&nbsp;"
													style="margin-left: 40px; margin-top: 30px;">
...
<!-- Mirrored from www.cliptheme.com/preview/admin/clip-one/form_validation.html by HTTrack Website Copier/3.x [XR&CO'2010], Sat, 09 Aug 2014 11:33:15 GMT -->
</html>