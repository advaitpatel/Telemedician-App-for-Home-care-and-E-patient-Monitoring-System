				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Check Your Daily Profits & Losses
								<p>
									<small>Note :- These Data are based on daily updation
										done by data operator. Some Minor differences may be possible
										here.</small>
								</p>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square teal"></i> VIEW NOW
								</h2>
								<p>Please beaware of hidden cameras and do not save your
									Login details for safety purpose.</p>
								<hr>
								<form action="#" role="form" id="form">
									<div class="row">
										...
										<div class="col-md-6" id="jo">
											<advait style="color:orange; font-size:20px;">
											<i>Overall Profit-Loss Details</i></advait>
											<br> <br>
											...
											<div class="form-group">
												<label class="control-label"> Select Duration <span
													class="symbol required"></span> </label> <select
													class="form-control" id="dropdown" name="dropdown">
													<option value="">Choose from here...</option>
													<option value="Category 1">5 days</option>
													<option value="Category 2">10 days</option>
													<option value="Category 3">15 days</option>
													<option value="Category 4">50 days</option>
												</select>
											</div>
											...
											<div class="col-md-4">
												<button class="btn btn-green btn-lg" type="submit"
													...
													Check Now <i class="clip-locked"></i>
												</button>
												<button type="submit" class="btn btn-beige btn-lg"
													style="margin-left: 350px; margin-top: -65px;">
													<i class="clip-unlocked"></i> &nbsp;Clear Now&nbsp;
												</button>
											</div>
										</div>
										<div class="col-md-6" id="jo">
											<advait style="color:orange; font-size:20px;">
											<i>Individual Profit-Loss Details</i></advait>
											<br> <br>
											<div class="form-group">
												<label class="control-label"> Select Item ID <span
													class="symbol required"></span> </label> <select
													class="form-control" id="dropdown" name="dropdown">
													<option value="">Choose from here...</option>
													<option value="Category 1">A</option>
