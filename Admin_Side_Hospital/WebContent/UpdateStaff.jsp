...
<!-- start: HEAD -->
<head>
<title>Welcome Staff Member :: Vision Medicare</title>
<!-- start: META -->
<meta charset="utf-8" />
...
<li><a href="summery.jsp" ><i class="clip-cog-2"></i>
		...
		<div class="main-content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<form action="Staff_Update.jsp" method="get" role="form" id="form">
							<div class="row">
								<div class="col-md-12">
									<h3>Welcome to Update Staffs' Records.</h3>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="phone" tabindex="12" id="mno"
								...
								<div class="col-md-6">
									...
									<div class="form-group" style="margin-top: 20px">
										<label class="control-label"><i
											class="clip-arrow-right-3"></i> Assigned Department <span
											class="symbol required"></span> </label> <input type="text"
											class="form-control" name="Dep" id="occupation" tabindex="9">
									</div>
									...
									<div class="form-group">
										<label class="control-label"><i
											...
											class="symbol required"></span> </label> <input tabindex="14"
