				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Medicines <small>By this, You can Insert, Update, &
									Delete your medicines records. </small>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square teal"></i> ENTER BELOW
								</h2>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label"> Enter Medicine ID <span
													...
													placeholder="Put here....." class="form-control"
													id="firstname" name="firstname">
											</div>

											<div class="form-group connected-group">
												<label class="control-label"> Select Medicine Name <span
											...
											<div class="form-group connected-group">
												<label class="control-label"> Select Company Name <span
													class="symbol required"></span> </label>
												<div class="row">
													<div class="col-md-7">
														<select name="mm" id="mm" class="form-control" required>
										...
										<div class="row">
											...
											<div class="col-md-4">
												...
												<button class="btn btn-yellow btn-lg" type="submit">
													Update <i class="clip-spinner-6"></i>
												</button>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
