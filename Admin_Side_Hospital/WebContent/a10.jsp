				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Check Visits <small>this action will give you a detailed
									summary of your Doctors and Patients' visits. </small>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square teal"></i> FILL HERE
								</h2>
								<p>Fill this details to see your transactions and payments.
								</p>
								<hr>
								<form action="#" role="form" id="form">
									<div class="row">
										...
										<div class="col-md-6">
												...
												<div class="row">
													<div class="col-md-7">
														<select name="mm" id="mm" class="form-control" required>
															<option value="Baroda">Choose from here.....</option>
															<option value="01">Doctor</option>
															<option value="02">Patient</option>
															<option value="02">Employee - Staff</option>
														</select>
													</div>
											...
											<div class="form-group connected-group">
												<label class="control-label"> Select Input <span
													class="symbol required"></span> </label>
												<div class="row">
													<div class="col-md-7">
														<select name="mm" id="mm" class="form-control" required>
															<option value="Baroda">Choose your option.....</option>
															<option value="01">Last Visits</option>
															<option value="02">Next Visits</option>
															<option value="03">All Visits</option>
														</select>
													</div>
											...
											<div class="form-group connected-group">
												...
												<div class="row">
													<div class="col-md-7">
														<select name="mm" id="mm" class="form-control" required
															disabled>
															<option value="Baroda">Doctor</option>
															<option value="01">Doctor</option>
															<option value="02">Patient</option>
															<option value="02">Employee - Staff</option>
														</select>
											...
											<div class="form-group connected-group">
												...
												<div class="row">
													<div class="col-md-7">
														<select name="mm" id="mm" class="form-control" required
															disabled>
															<option value="Baroda">Last Visits</option>
															<option value="01">Last Visits</option>
															<option value="02">Next Visits</option>
															<option value="03">All Visits</option>
														</select>
									...
									<div class="row">
										<div class="col-md-12">
											<div>
												<span class="symbol required"></span>Required Fields <span
													class="symbol required"
													style="font-size: 10px; color: gray; margin-left: 450px; margin-top: -30px;">There
													is an example which is done for you.</span>
									...
									<div class="row">
										<div class="col-md-8">
											<p>By clicking Check Now, you are agreeing to the Policy
												and Terms &amp; Conditions.</p>
										</div>

										<div class="col-md-4">
											<button class="btn btn-yellow btn-lg" type="submit">
												Check Now <i class="clip-thumbs-up"></i>
											</button>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="reset"
												class="btn btn-beige btn-lg"
												value="&nbsp;&nbsp;Try Again&nbsp;&nbsp;">
										</div>
									</div>
								</form>
