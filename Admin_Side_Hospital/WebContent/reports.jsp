				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Update Patient Reports <small>to your database</small>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square teal"></i> Updation
								</h2>
								<p>Choose Patient Name to update reports.</p>
								<hr>
								<sql:query var="pat" dataSource="${ad_log }">
									select distinct(patient) from appointment where doctor='<%= use %>';
								</sql:query>
								<form action="change_reports.jsp" role="" id="">
									<div class="row">
										<div class="col-md-2"></div>
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label"> Choose Name <span
													class="symbol required"></span> </label> 
													<select name="patient" class="col-md-6 form-control"> 
													<c:forEach var="row" items="${pat.rows }">
													<sql:query var="patt" dataSource="${ad_log }">
													select * from patient where user='${row.patient }';
													</sql:query>
													<c:forEach var="ro" items="${patt.rows }"> 
													<option value="${row.patient }"> <c:out value="${ro.First_name } ${ro.Last_name }"></c:out> </option>
													</c:forEach>
													</c:forEach>
													</select>
