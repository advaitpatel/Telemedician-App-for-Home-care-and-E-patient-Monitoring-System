...
<sql:query dataSource="${ad_log}" var="result">
		...
		<sql:query dataSource="${ad_log}" var="result123">
						select * from doctor;
		</sql:query>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Schedule Meeting <small>by this, You can fix a meeting
									with your Staff.</small>
							</h1>
						</div>
					...
					<div class="col-sm-6">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<form name="f1" action="NewSchedule.jsp">
								<br> <br> <br>
								<div class="col-md-11">
									<div class="form-group">
										<label class="control-label"> Select Meeting type <span
											class="symbol required"></span> </label> <select class="form-control"
											id="dropdown" name="type">
									...
									<div class="form-group">
										<label for="form-field-select-4"> Select Doctor
										         </label> 
										         <select class="form-control"  id="dropdown" name="name">
									
										
										
											<c:forEach var="row" items="${result123.rows}">
											
											<option value="${row.user}" name="name"><c:out value="${row.First_name} ${row.Last_name}"></c:out></option>
										</c:forEach>
									...
									<div class="form-group">
										<label for="form-field-23"> Subject of Meeting </label>
										<textarea maxlength="200" id="form-field-23"
											class="form-control limited" name="subject"></textarea>
									</div>
								</div>
								<p>&nbsp;&nbsp;&nbsp;&nbsp;Choose Meeting Date</p>
								...
								<br>
								<p>&nbsp;&nbsp;&nbsp;&nbsp;Choose Meeting Time</p>
								<div class="input-group input-append bootstrap-timepicker">
									<input type="text" name="time" class="form-control time-picker"> <span
