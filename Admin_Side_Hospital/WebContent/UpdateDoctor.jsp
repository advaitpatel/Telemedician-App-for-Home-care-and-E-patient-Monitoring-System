...
<!-- start: HEAD -->
<head>
<title>Welcome Doctor :: Vision Medicare</title>
<!-- start: META -->
<meta charset="utf-8" />
...
<li><a href="summery.jsp" ><i class="clip-cog-2"></i>
		...
		<div class="main-content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<form action="Doctor_Update.jsp" method="get" role="form" id="form">
							<div class="row">
								<div class="col-md-12">
									<h3>Welcome to Update Doctors' Records.</h3>
									<hr>
								</div>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<textarea tabindex="10" maxlength="80" name="Add" id="add"
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input type="number" tabindex="12" id=""
									...
									<div class="form-group">
										<label class="control-label"><i
											...
											data-rel="tooltip"
											data-original-title="Choose Your Blood Group" tabindex="14">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="form-field-select-4"> Specializations Of
											Doctor </label> <select multiple="multiple" id="form-field-select-4"
											class="form-control search-select" tabindex="9" name="Special">
											<option value="dnt">Dentist</option>
											<option value="hrt">Heart Specialist</option>
											<option value="fml">Family Doctor</option>
											<option value="srgn">Sergon</option>
											<option value="ent">ENT</option>
											<option value="srg">Sergon</option>
											<option value="ent">ENT</option>
											<option value="srg">Sergon</option>
											<option value="ent">ENT</option>
											<!-- 6 k 7 jetli values enter karvi to j o/p aavse-->
										</select>
									</div>
									...
									<div class="form-group">
										<label class="control-label"><i
											...
											class="symbol required"></span> </label> <input type="text"
											tabindex="11" class="form-control" id="username"
											name="User_name">
									</div>
									<br>
									<div class="form-group">
										<label class="control-label"><i
											...
											class="symbol required"></span> </label> <input tabindex="13"
									...
									<div class="form-group">
										<label class="control-label"><i
											...
											tabindex="15" class="form-control" id="password_again"
											name="Confirm-pwd">
									</div>
								...
								<div class="form-group">
									<div class="col-md-4">
										<input type="submit"
											...
											tabindex="17"> <input type="reset"
											value="&nbsp;Clear Records&nbsp;"
											class="btn btn-green btn-squared btn-lg"
											style="margin-left: 40px; margin-top: -400px;" tabindex="18">
									</div>
								</div>
