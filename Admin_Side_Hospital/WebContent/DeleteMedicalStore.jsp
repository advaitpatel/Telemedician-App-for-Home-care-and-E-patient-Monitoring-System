...
<head>
<title>Delete Medical Store :: Vision Medicare</title>
<!-- start: META -->
<meta charset="utf-8" />
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Delete Medical Store Records <small>in your database</small>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<p>Insert Name to Delete Medical Store's account from Vision
									Medicare.</p>
								<hr>
								<form action="Delete_MedicalStore.jsp" role="form" id="">
									<div class="row">
