				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Find best Medicines for you.<small>Note :- These
									Diagnosis are prescribed by our reliable Doctors. We are not
									responsible for any future issues. </small>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square teal"></i> UPDATE NOW
								</h2>
								<p>Please Select Your Perferences to get maximum advantage.
								</p>
								<hr>
								<form action="#" role="form" id="form">
									<div class="row">
										...
										<div class="col-md-6" id="jo">
											<br> <br>
											<div class="form-group">
												<label class="control-label"> Enter Dieases Name <span
													...
													<option value="Category 3">D</option>
													<option value="Category 4">E</option>
												</select>
											</div>
											<div class="form-group">
												<label class="control-label"> Enter Medicine Name <span
													class="symbol required"></span> </label> <select
													class="form-control" id="dropdown" name="dropdown">
													<option value="">Choose from here...</option>
													<option value="Category 1">Crossin</option>
													<option value="Category 2">Combiflame</option>
													<option value="Category 3">Vicks Action 500</option>
													<option value="Category 4">Aten 50</option>
												</select>
											</div>
											<div class="form-group">
												<label class="control-label"> Enter Dosage <span
													class="symbol required"></span> </label> <select
													class="form-control" id="dropdown" name="dropdown">
													<option value="">Choose from here...</option>
													<option value="Category 1">10</option>
													<option value="Category 2">20</option>
													<option value="Category 3">05</option>
													<option value="Category 4">30</option>
												</select>
											</div>
										</div>
										...
										<div class="row" id="side">
											<div class="col-md-8" id="chang">
												<p>By clicking "Track Now", you are agreeing to the
													Policy and Terms &amp; Conditions.</p>
											</div>
											<div class="col-md-4">
												<button class="btn btn-green btn-lg" id="savo" type="submit">
													Update Now <i class="fa fa-arrow-circle-right"></i>
												</button>
												<button type="submit" class="btn btn-yellow btn-lg"
													id="updo">
													<i class="clip-spinner-6"></i> &nbsp;&nbsp;Try
													Again&nbsp;&nbsp;
												</button>
