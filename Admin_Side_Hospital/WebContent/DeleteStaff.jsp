				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Delete Staff Records <small>to your database</small>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<p>Insert User Name to Delete Staff's account from Vision
									Medicare.</p>
								<hr>
								<form action="Delete_Staff.jsp" role="form" id="form">
									<div class="row">
