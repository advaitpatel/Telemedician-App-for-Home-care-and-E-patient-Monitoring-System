				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Add or Update Medicines <small>By this, You can Insert &
									Update your medicines records. </small>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h2>
									<i class="fa fa-pencil-square teal"></i> INSERT BELOW FOR
									CHANGES
								</h2>
								<p>Fill this details to perform operations.</p>
								<hr>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label"> Enter Medicine ID <span
											...
											<div class="form-group">
												<label class="control-label"> Enter Company Name <span
													class="symbol required"></span> </label> <input type="text"
													placeholder="Type here....." class="form-control"
													id="firstname" name="firstname">
											</div>
											...
											<div class="form-group">
												<label class="control-label"> Enter Medicine Cost <span
													class="symbol required"></span> </label> <input type="text"
													placeholder="Type here....." class="form-control"
													id="firstname" name="firstname">
											</div>
											<div class="form-group">
												<label class="control-label"> Enter Medicine
													Quantity <span class="symbol required"></span> </label> <input
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label"> Enter Medicine ID <span
													class="symbol required"></span> </label> <input type="text"
													disabled placeholder="110410116011" class="form-control"
													id="firstname" name="firstname">
											</div>
											<div class="form-group">
												<label class="control-label"> Enter Medicine Name <span
													class="symbol required"></span> </label> <input type="text"
													disabled placeholder="Vicks Action 500"
													class="form-control" id="firstname" name="firstname">
											</div>
											<div class="form-group">
												<label class="control-label"> Enter Company Name <span
													class="symbol required"></span> </label> <input type="text"
													disabled placeholder="Vicks" class="form-control"
													id="firstname" name="firstname">
											</div>
											...
											<div class="form-group">
												<label class="control-label"> Enter Medicine Cost <span
													class="symbol required"></span> </label> <input type="text"
													disabled placeholder="2.50" class="form-control"
													id="firstname" name="firstname">
											</div>
											<div class="form-group">
												<label class="control-label"> Enter Medicine
													Quantity <span class="symbol required"></span> </label> <input
													type="text" disabled placeholder="600" class="form-control"
													id="firstname" name="firstname">
											</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div>
													<span class="symbol required" style="margin-left: 20px;"></span>Required
													Fields
										...
										<div class="row">
											<div class="col-md-8">
												<p style="margin-left: 20px; color: gray; font-size: 13px;">
													By clicking Check Now, you are agreeing to the Policy and
													Terms &amp; Conditions.</p>
											</div>
