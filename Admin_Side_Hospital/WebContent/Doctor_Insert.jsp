...
<body>
	...
	<% out.print("insert into doctor (user,pass,First_name,Last_name,Gender,Address,Mobile,Email,Speciality,Blood_Group,Date,Month,Year) values ('"+U_name+"' , '"+Password+"', '"+F_name+"', '"+L_name+"', '"+Gender+"', '"+Address+"', '"+Mobile+"', '"+Email+"', '"+sp+"', '"+Blood_group+"', "+Date+", "+Month+", "+Year+");");%> 
	</sql:update>")   
