...
<body>
	...
	<% out.print("update doctor set First_name='"+F_name+"' where user='"+U_name+"';");%> 
	</sql:update>   

	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Last_name='"+L_name+"' where user='"+U_name+"';");%> 
	</sql:update>   
	
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Gender='"+Gender+"' where user='"+U_name+"';");%> 
	</sql:update>   
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Address='"+Address+"' where user='"+U_name+"';");%> 
	</sql:update>   
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Mobile='"+Mobile+"' where user='"+U_name+"';");%> 
	</sql:update>   
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Email='"+Email+"' where user='"+U_name+"';");%> 
	</sql:update>   
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Speciality='"+sp+"' where user='"+U_name+"';");%> 
	</sql:update>   
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Blood_Group='"+Blood_group+"' where user='"+U_name+"';");%> 
	</sql:update>   
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Date="+Date+"  where user='"+U_name+"';");%> 
	</sql:update>   
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Month="+Month+"  where user='"+U_name+"';");%> 
	</sql:update>   
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set Year="+Year+"  where user='"+U_name+"';");%> 
	</sql:update>   
	
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set user='"+U_name+"' where user='"+U_name+"';");%> 
	</sql:update>   
	<sql:update dataSource="${cl_reg}" var="result">
	<% out.print("update doctor set pass='"+Password+"' where user='"+U_name+"';");%> 
	</sql:update>   
