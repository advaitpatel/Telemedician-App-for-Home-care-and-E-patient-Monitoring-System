...
<!-- start: HEAD -->
<head>
<title>Error :: Vision Medicare</title>
<!-- start: META -->
<meta charset="utf-8" />
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12 page-error">
				<div class="error-number teal">SQL</div>
				<div class="error-details col-sm-6 col-sm-offset-3">
					<h3>Oops! You are stuck at Database</h3>
					<p>
						Unfortunately the data you were looking for could not be found. <br>
						It may be temporarily unavailable, moved or no longer exist. <br>
						Check the credentials you entered for any mistakes and try again.
						<br> <a href="index.jsp" class="btn btn-teal btn-return">
							Return home </a> <br> Still no luck? <br> Search for
						whatever is missing, or take a look around the rest of our site.
					</p>
					<form action="#">
						<div class="input-group form-group">
							<input type="text" placeholder="keyword..." size="16"
								class="form-control" id="search"> <span
								class="input-group-btn">
								<button class="btn btn-teal control-label">Search</button> </span>
						</div>
					</form>
				</div>
			</div>
