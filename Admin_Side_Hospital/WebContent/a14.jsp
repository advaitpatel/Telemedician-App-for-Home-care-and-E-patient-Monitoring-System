...
<!-- Mirrored from www.cliptheme.com/preview/admin/clip-one/form_wizard.html by HTTrack Website Copier/3.x [XR&CO'2010], Sat, 09 Aug 2014 11:33:13 GMT -->
<head>
<title>Vision Medicare - Welcome user</title>
<!-- start: META -->
<meta charset="utf-8" />
				...
				<ul class="nav navbar-right">
					...
					<li class="dropdown"><a data-toggle="dropdown"
						...
						<ul class="dropdown-menu todo">
								...
								<div class="drop-down-wrapper">
									<ul>
										<li><a class="todo-actions" href="javascript:void(0)">
												...
												style="opacity: 1;"> today</span> </a></li>
										<li><a class="todo-actions" href="javascript:void(0)">
												<i class="fa fa-square-o"></i> <span class="desc"
							...
							<li class="view-all"><a href="javascript:void(0)"> See
									all tasks <i class="fa fa-arrow-circle-o-right"></i> </a></li>
						</ul></li>
					<!-- end: TO-DO DROPDOWN-->
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu posts">
							<li><span class="dropdown-menu-title"> You have 2
									messages</span></li>
							<li>
								<div class="drop-down-wrapper">
									<ul>
										<li><a href="javascript:;">
												<div class="clearfix">
													<div class="thread-image">
														<img alt="" src="assets/images/IMG-20141113-WA001(1).jpg">
													</div>
													<div class="thread-content">
														<span class="author">Advait Patel</span> <span
															class="preview">Your Message has been sent
															successfully to me. Thank You.</span> <span class="time">
															Just Now</span>
													</div>
												</div> </a></li>
										<li><a href="javascript:;">
												<div class="clearfix">
													<div class="thread-image">
														<img alt="" src="assets/images/IMG-20141113-WA002(1).jpg">
													</div>
													<div class="thread-content">
														<span class="author">Krishna Gandhi</span> <span
															class="preview">Please Send me some info of
															project. Waiting for your responce.</span> <span class="time">2
															mins</span>
													</div>
												</div> </a></li>
							...
							<li class="view-all"><a href="pages_messages.html"> See
									all messages <i class="fa fa-arrow-circle-o-right"></i> </a></li>
						</ul></li>
					...
					<li class="dropdown current-user"><a data-toggle="dropdown"
						...
						data-close-others="true" href="#"> <img
							src="assets/images/IMG-20141113-WA002(1).jpg" class="circle-img"
							alt=""> <span class="username">Krishna Gandhi</span> <i
						...
						<ul class="dropdown-menu">
							...
							<li><a href="pages_calendar.html"> <i
									class="clip-calendar"></i> &nbsp;My Calendar </a>
	...
	<div class="main-container">
		<div class="navbar-content">
			...
			<div class="main-navigation navbar-collapse collapse">
				...
				<ul class="main-navigation-menu" style="margin-top: 10px;">
					...
					<li><a href="javascript:void(0)"><i class="clip-screen"></i>
						...
						<ul class="sub-menu">
							<li><a href="layouts_horizontal_menu1.html"> <span
									class="title"> Staff Record </span> <span
									class="badge badge-new">new</span> </a></li>
					...
					<li><a href="" target=""><i class="clip-cursor"></i> <span
					...
					<li><a href="javascript:void(0)"><i class="clip-cog-2"></i>
							<span class="title"> E-diagnosis </span><i class="icon-arrow"></i>
							<span class="selected"></span> </a>
						<ul class="sub-menu">
							<li><a href="ui_elements.html"> <span class="title">
										Insert </span> </a></li>
					...
					<li><a href="charts.html"><i class="clip-bars"></i> <span
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div id="style_selector" class="hidden-xs">
							<div id="style_selector_container">
								...
								<div class="images boxed-patterns">
									...
									</a> <a id="bg_style_2" href="#"><img alt=""
										src="assets/images/bg_2.png">
									</a> <a id="bg_style_3" href="#"><img alt=""
										src="assets/images/bg_3.png">
									</a> <a id="bg_style_4" href="#"><img alt=""
										src="assets/images/bg_4.png">
									</a> <a id="bg_style_5" href="#"><img alt=""
								...
								<div class="images icons-color">
									<a id="light" href="#"><img class="active" alt=""
										src="assets/images/lightgrey.png">
									</a> <a id="dark" href="#"><img alt=""
										src="assets/images/darkgrey.png">
									</a> <a id="black_and_white" href="#"><img alt=""
										src="assets/images/blackandwhite.png">
									</a> <a id="navy" href="#"><img alt=""
										src="assets/images/navy.png">
									</a> <a id="green" href="#"><img alt=""
								...
								<div class="images">
									...
									<div class="form-group">
										...
										<div class="dropdown">
											<a class="add-on dropdown-toggle" data-toggle="dropdown"><i
												style="background-color: #555555"></i>
											</a>
											<ul class="dropdown-menu pull-right">
												<li>
													<div class="colorpalette"></div></li>
						...
						<div class="page-header">
							<h1>
								Adding a new User <small>to system database.</small>
							</h1>
						</div>
					...
					<div class="col-sm-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<i class="fa fa-external-link-square"></i> Follow this wizard to
								add a new user without any queries.
							...
							<div class="panel-body">
								<form action="#" role="form"
									...
									<div id="wizard" class="swMain">
										<ul>
											<li><a href="#step-1">
													<div class="stepNumber">1</div> <span class="stepDesc">
														Step 1 <br /> <small>Login Credentials</small> </span> </a></li>
											<li><a href="#step-2">
													<div class="stepNumber">2</div> <span class="stepDesc">
														Step 2 <br /> <small>Personal Details</small> </span> </a></li>
											<li><a href="#step-3">
													<div class="stepNumber">3</div> <span class="stepDesc">
														Step 3 <br /> <small>Contact Informations</small> </span> </a></li>
											<li><a href="#step-4">
													<div class="stepNumber">4</div> <span class="stepDesc">
														Step 4 <br /> <small>View Account details</small> </span> </a></li>
										</ul>
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control" id="username"
														name="username" placeholder="Text Field">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="email" class="form-control" id="email"
														name="email" placeholder="Text Field">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="password" class="form-control" id="password"
														name="password" placeholder="Text Field">
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label"> Confirm
													Password <span class="symbol required"></span> </label>
												<div class="col-sm-7">
										...
										<div id="step-2">
											...
											<div class="form-group">
												<label class="col-sm-3 control-label"> full_name <span
													class="symbol required"></span> </label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="full_name"
														name="full_name" placeholder="Text Field">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-7">
													<label class="radio-inline"> <input type="radio"
														class="grey" value="f" name="gender" id="gender_female">
														Female </label> <label class="radio-inline"> <input
														type="radio" class="grey" value="m" name="gender"
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control" id="address"
														name="address" placeholder="Text Field">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control" id="city"
														name="city" placeholder="Text Field">
												</div>
											</div>
											<div class="form-group">
										...
										<div id="step-3">
											...
											<div class="form-group">
												<label class="col-sm-3 control-label"> Personal
													Email <span class="symbol required"></span> </label>
												<div class="col-sm-7">
													<input type="email" class="form-control" id="pemail"
														name="pemail" placeholder="Text Field">
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label"> Office Email
													<span class="symbol required"></span> </label>
												<div class="col-sm-7">
													<input type="email" class="form-control" id="oemail"
														name="oemail" placeholder="Text Field">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control" id="phone"
														name="phone" placeholder="Text Field">
												</div>
											</div>

											<div class="form-group">
												<label class="col-sm-3 control-label"> WhatsApp
													Number <span class="symbol required"></span> </label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="wphone"
														name="wphone" placeholder="Text Field">
												</div>
											</div>
										...
										<div id="step-4">
											<h2 class="StepTitle">Step 4 Account Details</h2>
											<h3>Account</h3>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="col-sm-3 control-label"> Mobile Phone:
												</label>
												<div class="col-sm-7">
													<p class="form-control-static display-value"
...
<!-- Mirrored from www.cliptheme.com/preview/admin/clip-one/form_wizard.html by HTTrack Website Copier/3.x [XR&CO'2010], Sat, 09 Aug 2014 11:33:14 GMT -->
</html>