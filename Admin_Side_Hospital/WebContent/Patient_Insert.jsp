...
<body>
	...
	<% out.print("insert into patient(user,pass,First_name,Last_name,Gender,Address,Mobile,Email,Blood_group,Date,Month,Year) values ('"+U_name+"' , '"+Password+"', '"+F_name+"', '"+L_name+"', '"+Gender+"', '"+Address+"', '"+Mobile+"', '"+Email+"','"+Blood_group+"', "+Date+", "+Month+", "+Year+");");%> 
	</sql:update>")   
