									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
											...
											<tr>
												...
												<td class="center"><c:out value="${row.Open_Time}"/></td>
												<td class="center"><c:out value="${row.Close_Time}"/></td>
												<td class="center"><c:out value="${row.Date} / ${row.Month} / ${row.Year}"/></td>
