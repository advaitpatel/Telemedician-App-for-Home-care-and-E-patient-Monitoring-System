...
<head>
<title>Delete Medicine :: Vision Medicare</title>
<!-- start: META -->
<meta charset="utf-8" />
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Delete Medicine Records <small>to your database</small>
							</h1>
						</div>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<p>Insert Name to Delete Medicine's Record from Vision
									Medicare.</p>
								<hr>
								<form action="Delete_Medicine.jsp" role="form" id="form">
									<div class="row">
