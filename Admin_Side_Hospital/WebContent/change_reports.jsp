...
String ss1=request.getParameter("patient");

ses.setAttribute("p_rep",ss1);
if(use==null)
{
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Upload Patient Reports <small>to your database</small>
							</h1>
						</div>
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
														...
														<input type="hidden" name="type1" value="Bill">
														<div class="fileupload fileupload-new" data-provides="fileupload">
															...
															<div class="user-edit-image-buttons">
																<span class="btn btn-light-grey btn-file"><span class="fileupload-new"><i class="fa fa-picture"></i> Select image</span><span class="fileupload-exists"><i class="fa fa-picture"></i> Change</span>
																	<p><input type="file" name="Imagefile" id="Imagefile"></p>
																</span>
