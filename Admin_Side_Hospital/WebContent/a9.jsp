				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="page-header">
							<h1>
								Check Billing Summary <small>this action will give you a
									detailed summary of your transactions and records. </small>
							</h1>
						</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group connected-group">
												<label class="control-label"> Select Date <span
											...
											<div class="form-group connected-group">
												<label class="control-label"> Number of Records you
													want to see <span class="symbol required"></span> </label>
												<div class="row">
													<div class="col-md-7">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<label class="control-label"> First Name <span
													class="symbol required"></span> </label> <input type="text"
													placeholder="Advait" class="form-control" id="firstname"
											...
											<div class="form-group connected-group">
												...
												<div class="row">
													...
													<div class="col-md-3">
														<input type="text" placeholder="2014" id="yyyy"
															name="yyyy" class="form-control" disabled>
													</div>
												</div>
											</div>
