								...
								<div class="panel-body">
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
															...
															<c:forEach var="row" items="${result.rows}">
											<tr>
												<td class="center"><c:out value="${row.id}"/></td>
												<td class="center"><c:out value="${row.Name}"/></td>
												<td class="center"><c:out value="${row.Des}"/></td>
												<td class="center"><c:out value="${row.Company}"/></td>
												<td class="center"><c:out value="${row.Quantity}"/></td>
												<td class="center"><c:out value="${row.Medical_Store}"/></td>
