				...
				<div class="row">
					<div class="col-sm-12">
						<form action="#" method="get" role="form" id="form">
							<div class="row">
								<div class="col-md-12">
									<h3>Welcome to insert New Admins' Records.</h3>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<div>
											<label class="radio-inline"> <input type="radio"
												...
												<input type="radio" class="green" value="" name="gender"
									...
									<div class="form-group">
										...
										<textarea tabindex="10" maxlength="80" rows="4" name="Add"
									...
									<div class="form-group">
										<label class="control-label"><i
											...
											data-rel="tooltip"
											data-original-title="Choose Your Blood Group" tabindex="13">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label class="control-label"><i
											...
											tabindex="14" class="form-control" id="password_again"
											name="Confirm-pwd">
									</div>
								...
								<div class="form-group">
									<div class="col-md-4">
										<input type="submit"
											...
											tabindex="16"> <input type="reset"
											value="&nbsp;Clear Records&nbsp;"
											class="btn btn-green btn-squared btn-lg"
											style="margin-left: 40px; margin-top: -400px;" tabindex="17">
									</div>
								</div>
