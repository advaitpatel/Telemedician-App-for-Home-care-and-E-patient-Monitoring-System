		...
		<section class="wrapper">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 panel panel-default panel-heading">
						<h3 class="text-primary" align="center">Please, Select Your Choices for Appointment.
						</h3>
						<div class="well well-lg col-md-12">
							<div class="col-sm-6">
								<form role="form" method="get" name="f7" class="horizontal-form margin-bottom-40" action="date_of_doctor_appointment.jsp">
									<div class="form-group">
										...
										<select class="form-control" id="dropdown" name="dropdown">
											...
											<option value="Category 1">Dentist</option>
											<option value="Category 2">Heart Special</option>
											<option value="Category 3">Cardiologist</option>
											<option value="Category 4">Physician</option>
										</select>
									</div>
									...
									<sql:setDataSource var="{cl_reg}"
										...
										user="root" password="haresh"
									/>
										<sql:query var="result" dataSource="${cl_reg}">
										select * from doctor;
										</sql:query>
										
									<div class="form-group">
										<label class="control-label">
											Doctor Name <span class="symbol required"></span>
										</label>
										<select class="form-control"  id="dropdown" name="drname">
										
										
										
											<c:forEach var="row" items="${result.rows}">
											
											<option value="${row.user}" name="drname"><c:out value="${row.First_name } ${row.Last_name}"></c:out></option>
											</c:forEach>
