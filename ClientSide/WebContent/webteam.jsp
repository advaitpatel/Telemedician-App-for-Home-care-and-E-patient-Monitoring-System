		...
		<div class="main-container">
			<section class="wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="center">Meet Our Web Team</h1>
							<p class="center">
							...
							<div class="row">
								<ul class="team-list animate-group">
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img class="animate" src="assets/images/advait.jpg" alt="" data-animation-options='{"animation":"fadeInLeft", "duration":"300"}'>
									...
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img class="animate" src="assets/images/krishna.jpg" style="height: 360px" alt="" data-animation-options='{"animation":"fadeInLeft", "duration":"300"}'>
											<span class="image-overlay"></span>
										</div>
										<h3>Krishna Gandhi</h3>
										<div>
											Document Handler & Content Writer
										</div>
									</li>
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img class="" src="assets/images/haresh.jpg" alt="" >
											<span class="image-overlay"></span>
										</div>
										<h3>Haresh Moorjani</h3>
										<div>
											Backend Coder & Graphic Designer
										</div>
									</li>
								</ul>
							</div>
...
<!-- Mirrored from www.cliptheme.com/preview/frontend/clip-one/pages_team.html by HTTrack Website Copier/3.x [XR&CO'2010], Mon, 01 Sep 2014 10:04:46 GMT -->
</html>
