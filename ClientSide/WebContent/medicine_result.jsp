					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<sql:query dataSource="${cl_reg}" var="appoint">
								SELECT distinct(medicine) FROM admin_hospital.history where medicine is not null and p_user='<%=ss%>';
							</sql:query> 
							...
							<div class="search-classic">
								...
								<div class="search-result">
									...
									<a href="#">
										...
										<b><c:out value="${count }"></c:out> : <c:out value="${row.medicine}" /></b> 
