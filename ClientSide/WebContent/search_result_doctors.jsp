						...
						<ul class="nav navbar-nav navbar-right">
							...
							%>
							 <sql:setDataSource var="cl_reg" driver="com.mysql.jdbc.Driver"
								...
								select * from doctor where area="<%=area%>";
							</sql:query>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="search-classic">
								...
								<h3>Search results for Doctors</h3>
								<hr>
								<c:forEach var="row" items="${result1.rows }">
								<div class="search-result">
									<h4>
									<a href="#">
										<b>Name : <c:out value="${row.First_name } ${row.Last_name }" /></b> 
									</a></h4>
									<a href="#">
										<b>Email : <c:out value="${row.email}" /></b>
									</a>
									<p>

									</p>
									<form name="f1" action="doctor_profile.jsp">
												<input type="hidden" name="name" value="<c:out value="${row.user }" />">
												<input type="submit" name="submit" value="View Profile" class="btn btn-success">  
										 </form>
								</div>
								<hr>
								</c:forEach>
