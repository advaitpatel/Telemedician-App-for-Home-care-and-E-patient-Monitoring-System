...
<div role="navigation" class="navbar navbar-default navbar-fixed-top space-top">
		...
		<section class="wrapper">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h3 class="text-primary" align="center">Please, Select Your area From Here to search Medical stores.
						</h3>
						<div class="well well-lg col-md-12">
							<div class="col-sm-6">
								<form role="form" method="get" name="f7" class="horizontal-form margin-bottom-40" action="search_result_stores.jsp">
