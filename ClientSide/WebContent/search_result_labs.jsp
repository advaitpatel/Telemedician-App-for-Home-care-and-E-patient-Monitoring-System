						...
						<ul class="nav navbar-nav navbar-right">
							...
							%>
							 <sql:setDataSource var="cl_reg" driver="com.mysql.jdbc.Driver"
								...
								select * from labs where area="<%=area%>";
							</sql:query>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="search-classic">
								...
								<h3>Search results for Medical Labs</h3>
								<hr>
								<c:forEach var="row" items="${result1.rows }">
								<div class="search-result">
									<h4>
									<a href="#">
										<b>Name : <c:out value="${row.name }" /></b> 
									</a></h4>
									<a href="#">
										<b>Email : <c:out value="${row.number}" /></b>
									</a>
									<p>
									Add : <c:out value="${row.add }"></c:out> <br>
									 --> <c:out value="${row.notes }"></c:out>
