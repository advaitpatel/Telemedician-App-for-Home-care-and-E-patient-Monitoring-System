...
<html lang="en">
	...
	<!-- start: HEAD -->
	<head>
		<title>Vision Medicare - Introduction</title>
		<!-- start: META -->
		...
		<div class="main-container">
			<section class="wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-7">
							<h3>Welcome To Vision Medicare</h3>
							<p>
								Vision Medicare is having the selling rights of Zee laboratories. It is having the franchisees rights for Vadodara and Panchmahal district. It is mainly dealing with OrevaDermanance/Axyzen Life science & Lenarlclabs. Main customers of the company are Doctors &Chemist.
							</p>
							<p>
								Vision Medicare was started on 15th June 2010.The company reach to the successful business today. Vision Medicare is available at Sansthavasahat Vadoadara. The vision of the Vision Medicare is to reach all over in Gujarat by the end of the march 2016.
							</p>
							<p>
								Vision Medicare is an Indian Medicare Company for Medicines. Vision Medicare is getting the prescriptions from Doctor and the prescriptions are honored at chemist level. Stodctst of individual area are called the business of vision Medicare.
							</p>
						</div>
						<div class="col-md-5">
					...
					<div class="row">
						<div class="col-md-7">
							...
							<div class="progress-bars">
									...
									<div class="progress-label">
										<span>Book Your Appointment to avoid Qs</span>
									</div>
									<div class="progress">
										<div class="progress-bar main-color animate-bar six-sec-ease-in-out" aria-valuetransitiongoal="95"></div>
									</div>
									<div class="progress-label">
										<span>International Patients</span>
									</div>
									<div class="progress">
										<div class="progress-bar main-color animate-bar six-sec-ease-in-out" aria-valuetransitiongoal="90"></div>
									</div>
									<div class="progress-label">
									...
									<div class="progress">
										<div class="progress-bar main-color animate-bar six-sec-ease-in-out active" aria-valuetransitiongoal="99"></div>
									</div>
									<div class="progress-bars">
									<div class="progress-label">
									...
									<div class="progress-label">
										<span>E-Health Care</span>
									</div>
									<div class="progress">
										<div class="progress-bar main-color animate-bar six-sec-ease-in-out" aria-valuetransitiongoal="90"></div>
									</div>
									<div class="progress-label">
										<span>Home Care CheckUps</span>
									</div>
									<div class="progress">
										<div class="progress-bar main-color animate-bar six-sec-ease-in-out" aria-valuetransitiongoal="92"></div>
									</div>
									<div class="progress-label">
										<span>Ambulance</span>
									</div>
									<div class="progress">
										<div class="progress-bar main-color animate-bar six-sec-ease-in-out" aria-valuetransitiongoal="93"></div>
									</div>
									<div class="progress-label">
										<span>Emergency</span>
									</div>
									<div class="progress">
										<div class="progress-bar main-color animate-bar six-sec-ease-in-out active" aria-valuetransitiongoal="100"></div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-5">
							<h3>Who Is Vision Medicare</h3>
							<div class="panel-group accordion-custom accordion-teal" id="accordion">
								<div class="panel panel-default">
									...
									<div id="collapseOne" class="panel-collapse collapse">
										<div class="panel-body">
											<p>
												"Vision Medicare believes that the brotherhood of man transcends the national borders. They strive to offer the widely recognized Indian intelligence in the field of Medical world at large to uplift the quality of human life."
											</p>
										</div>
									</div>
								</div>
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">
											<p>
												" Vision Medicare aims at ensuring growth for their clients and employees and to be continuously improving and innovating their services and products by building long term 
								...
								<div class="panel panel-default">
									...
									<div id="collapseFour" class="panel-collapse collapse">
										<div class="panel-body">
											<p>
												Vision Medicare is a medicine Product based company who develops different medicine products and sell into Market. Vision Medicare is only Product based company who creates products for their customer.
											</p>
										</div>
									</div>
								</div>
