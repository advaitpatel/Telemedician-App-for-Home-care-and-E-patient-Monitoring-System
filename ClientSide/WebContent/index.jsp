		...
		<div class="main-container">
				...
				<div class="fullwidthabnner">
					<ul>
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							...
							data-start="2000"
							data-easing="easeOutExpo">
								Best services and medicaines from the glob
							</div>
							...
							<a class="caption lft btn btn-green slide_btn slide_item_left" href="SignUp.jsp"
							data-x="0"
							data-y="320"
							data-speed="400"
							data-start="3000"
							...
							data-start="1000"
							data-easing="easeOutExpo"  >
								<img src="assets/images/sliders/39.jpg" alt="Image 1">
							</div>
						</li>
						<!-- end: FIRST SLIDE -->
						<!-- start: SECOND SLIDE -->
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							...
							data-start="2500"
							data-easing="easeOutExpo">
								Find Medicines from home and save your time
								<br>
								Find medical stores near to you.
							</div>
							<a class="caption lfb btn btn-bricky slide_btn slide_item_left" href="SignUp.jsp"
							data-x="0"
							data-y="320"
							data-speed="400"
							data-start="3000"
							...
							data-easing="easeOutBack">
								<img src="assets/images/sliders/41.jpg" alt="Image 1">
							</div>
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							...
							data-start="2000"
							data-easing="easeOutExpo">
								We provide you best services with all the facilities.
							</div>
							...
							data-start="2500"
							data-easing="easeOutExpo">
								You can use it with great flexibilty
								<br>
								Take appointments from home !!!
							</div>
							<a class="caption sfb btn btn-purple slide_btn slide_item_left" href="SignUp.jsp"
							data-x="0"
							data-y="320"
							data-speed="400"
							data-start="3000"
							...
							data-start="1000"
							data-easing="easeOutBack">
								<img src="assets/images/sliders/15.jpg" alt="Image 1">
							</div>
						...
						<div class="col-sm-4">
							<div class="core-box">
								<div class="heading">
									...
									Emergency Helplines <i class="fa fa-arrow-circle-right"></i>
								</a>
								</div>
								<div class="content">
									<a class="btn btn-blue btn-lg">
									&nbsp;&nbsp;Mobile Applications&nbsp;<i class="fa fa-arrow-circle-right"></i>
								</a>
								</div>
							</div>
						</div>
			...
			<section class="wrapper wrapper-grey padding50">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h2 class="center">Our Center of Excellence</h2>
							<div class="grid-container animate-group" data-animation-interval="100">
									...
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/bariatric.png" class="img-responsive"/>
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/cardiology.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/Organ-Transplant.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												Organ-Transplant
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/oncology.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												Oncology Section
							...
							<div class="grid-container animate-group" data-animation-interval="100">
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/icu.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												ICU Section
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/highrisk.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												Highrisk Treatment
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/plastic-&-reconstructive-surgery.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/joint_re.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/neonatalpaediatrics.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/nephrology.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												Nephrology Section
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/neurology.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												Neurology Treatment
								...
								<div class="col-md-2 col-sm-4">
									<div class="grid-item animate">
										<a href="#">
											<div class="grid-image">
												<img src="assets/images/services/Haemto-oncologybonemarrowtransplant.png" class="img-responsive"/>
												<span class="image-overlay"> <i class="fa fa-mail-forward circle-icon circle-main-color"></i> </span>
											</div>
											<div class="grid-content">
												Haemto bonemarrow Transplant
											</div>
										</a>
									</div>
								</div>
			...
			<section class="wrapper wrapper-grey padding50">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h2 class="center">Find Your Medicines from here</h2>
							<h4 class="center">Here are some excellent medicines which will remove all your queries.</h4>
							<h6 class="center">Pre-scribed by our medical experts.</h6>
							<div class="grid-container animate-group" data-animation-interval="100">
								<div class="col-md-2 col-sm-4">
									<li class="dropdown">
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="core-box">
								...
								<div class="content">
									Make an appointment with your choice's doctor and avoid waiting in queue.
								</div>
								<a href="doctor_appointment.jsp"><input type="submit" value="Make Appointment" class="btn btn-green"></a>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="core-box">
								...
								<div class="content">
									Find best available doctors in your area. Book you appoinyment with best doctor available.
								</div>
								<a href="doctor_search.jsp"><input type="submit" value="Find Doctor" class="btn btn-green"></a>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="core-box">
								...
								<div class="content">
									Find medicines of your choice and make track of your prescribtion.
								</div>
								<a href="seach_medicalstore.jsp"><input type="submit" value="Find Medical Store" class="btn btn-green">
							</div>
						</div>
					</div>
				</div>
