...
<div role="navigation" class="navbar navbar-default navbar-fixed-top space-top">
		...
		<div class="main-container">
			<section class="wrapper portfolio-page">
				<div class="container">
					<div class="controls">
						<h3><center> Here You can manage your medical reports, bills etc...</center></h3>
					...
					<ul id="Grid" class="list-unstyled">
						...
						<li class="col-md-3 col-xs-12 mix category_3 filter" data-cat="3" data-filter="category_1">
							<div class="portfolio-item img-thumbnail">
								<a class="thumb-info" href="#">
									<img src="assets/images/slidebg1.jpg" class="img-responsive" alt="">
