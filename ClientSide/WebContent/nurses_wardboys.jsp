	...
	<body>
		...
		<div class="main-container">
			<section class="wrapper portfolio-page">
				<div class="container">
					<div class="controls">
						<h3>Our Nurses & Ward Boys Staff</h3>
					...
					<ul id="Grid" class="list-unstyled">
						<li class="col-md-3 col-xs-12 mix category_1" data-cat="1">
							<div class="portfolio-item img-thumbnail">
								<a class="thumb-info" href="assets/images/sagar.jpg">
									<img src="assets/images/sagar.jpg" class="img-responsive" alt="">
									<span class="thumb-info-title"> <span class="thumb-info-inner">Sagar Vardani</span> </span>
						...
						<li class="col-md-3 col-xs-12 mix category_2" data-cat="2">
							<div class="portfolio-item img-thumbnail">
								<a class="thumb-info" href="assets/images/darshan.jpg">
									...
									<span class="thumb-info-title"> <span class="thumb-info-inner">Darshan Jain</span></span>
									<span class="image-overlay"> <i class="clip-fullscreen circle-icon circle-main-color"></i> </span>
								</a>
							</div>
						</li>
