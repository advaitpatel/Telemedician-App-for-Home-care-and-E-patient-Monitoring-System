				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="callus">
								Contact us:<a href="#"> (click here)</a> - Mail:
								<a href="#">
						...
						<div class="col-sm-6">
							...
							<div class="social-icons" style="margin-left:300px;margin-top:2px;">
								...
								| Emergency XXX-XXX-XXXX | XXX-XXX-XXXX
							</button>
							</div>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li>
										<a href="outpatient.jsp">
											Patients
										</a>
									</li>
									<li>
										<a href="criticalcare.jsp">
											Critical Care
										</a>
									</li>
									<li>
										<a href="emergency_trauma.jsp">
							...
							<li class="dropdown">
								<a class="dropdown-toggle" href="#" data-toggle="dropdown" data-hover="dropdown">
									Patients <b class="caret"></b>
								</a>
								<ul class="dropdown-menu">
									<li>
										<a href="pages_about.jsp">
											In Patients
										</a>
									</li>
									<li>
										<a href="outpatients.jsp">
											Out Patients
										</a>
									</li>
									<li>
										<a href="pages_careers.jsp">
											Patient Guide
										</a>
									</li>
									<li>
										<a href="pages_faq.jsp">
										...
										<div class="mega-menu-content">
											<div class="row">
												<div class="col-sm-3">
													<ul class="sub-menu">
														<li>
															...
															<ul class="sub-menu">
																<li>
																	<a href="features_icons.jsp">
																		Permanant Doctors
																	</a>
																</li>
																<li>
																	<a href="features_buttons.jsp">
																		Visiting Doctors
																	</a>
																</li>
																<li>
																	<a href="features_animations.jsp">
																		Specialized Doctors
																	</a>
																</li>
															</ul>
												...
												<div class="col-sm-3">
													<ul class="sub-menu">
														<li>
															...
															<ul class="sub-menu">
																<li>
																	<a href="extra_search_result.jsp">
																		OT Nurses
																	</a>
																</li>
																<li>
																...
																<li>
																	<a href="extra_404.jsp">
																		Ambulance Drivers
																	</a>
																</li>
																<li>
																	<a href="extra_500.jsp">
																		Cleaners
																	</a>
																</li>
																<li>
												...
												<div class="col-sm-3">
													<ul class="sub-menu">
														<li>
															...
															<ul class="sub-menu">
																<li>
																	<a href="blog_page.jsp">
																		Doctor-Secrataries
																	</a>
																</li>
																<li>
																	<a href="blog_post.jsp">
																		Home Care Peons
																	</a>
																</li>
																<li>
												...
												<div class="col-sm-3">
													<ul class="sub-menu">
														<li>
															<span class="mega-menu-sub-title">Head Securities</span>
															<ul class="sub-menu">
																<li>
																	<a href="blog_page.jsp">
																		Main Gate Security
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="portfolio_example1.jsp">
											Visiting Hours
										</a>
									</li>
									<li>
										<a href="portfolio_example2.jsp">
											Convencience & Facilities
										</a>
									</li>
									<li>
										<a href="portfolio_example3.jsp">
											DOs & DONTs
										</a>
									</li>
								</ul>
