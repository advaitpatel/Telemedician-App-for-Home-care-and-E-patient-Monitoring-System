				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6" style="margin-left:280px;">
							<h2 style="margin-top:-65px;margin-left:150px;">Please Select Your Doctor.</h2>
							<!-- BEGIN FORM-->
							<form role="form" action="doctor_profile.jsp" name="" method="get" class="horizontal-form margin-bottom-40">
								<div class="form-group">
									<label class="control-label">
										Choose Specialization from here <span class="symbol required"></span>
									</label>
									<select class="form-control" id="dropdown" name="dro">
										<option value="">Select...</option>
										<option value="Category 1">Heart special</option>
										<option value="Category 2">Dentist</option>
										<option value="Category 3">Sergent</option>
										<option value="Category 4">Urgent</option>
									</select>
									<br>
									...
									<label class="control-label">
										Choose Doctor Name from here <span class="symbol required"></span>
									</label>
									<select class="form-control" id="dropdown" name="name" required>
											<option value="">...</option>
											
											<c:forEach var="row" items="${doc.rows}">
											
											
											<option value='<c:out value="${row.user}" />' > <c:out value="${row.First_name} ${row.Last_name }" /> </option>
											
											</c:forEach>
										</select>
								</div>
								<input class="btn btn-main-color btn-block" type="submit" name="submit" value="Check For Details">
