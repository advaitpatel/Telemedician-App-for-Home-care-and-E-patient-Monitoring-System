...
<body class="login example1">
	...
	<div
		...
		<div class="box-login" style="margin-top: -50px;">
			<center><b><h2>Sign in to your account</h2></b></center>
				...
				<fieldset>
					<div class="form-group">
						<span class="input-icon"> <input type="text"
							class="form-control login error" name="username"
					...
					<div class="form-group form-actions">
						<span class="input-icon"> <input type="password"
							class="form-control password login error" name="password"
					...
					<div class="new-account">
						Don't have an account yet? <a href="SignUp.jsp" class="register">
							Create an account </a>
					</div>
				</fieldset>
			</form>
