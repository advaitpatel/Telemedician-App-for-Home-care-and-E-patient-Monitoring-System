			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 panel panel-default panel-heading">
						<h3 class="text-primary" align="center">Please, Select Your Date for Appointment.
						</h3>
						<div class="well well-lg col-md-12">
							<div class="col-sm-6">
								<form role="form" method="get" name="f7" class="horizontal-form margin-bottom-40" action="choose.jsp">
									
									
									<%
									
									String s1=request.getParameter("drname");
									...
									if(docname!=null)
									{
										sesdr.setAttribute("dr",docname);
										%>
										<sql:query var="doc" dataSource="${cl_reg }">
										select * from doctor where user='<%=docname %>';  
										</sql:query>
										...
										select * from doctor_avail where name='${dd }';
										</sql:query>
										<%
									}
									else
									{
										sesdr.setAttribute("dr",s1);
									%>
									...
									<div class="form-group">
										...
										<select class="form-control"  id="dropdown" name="date">
									
										
										
											<c:forEach var="row" items="${result.rows}">
											
											<option value="${row.date}" name="date"><c:out value="${row.date } "></c:out></option>
										</c:forEach>
