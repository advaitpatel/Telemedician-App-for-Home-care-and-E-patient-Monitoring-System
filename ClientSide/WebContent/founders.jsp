		...
		<div class="main-container">
			<section class="wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="center">Meet the Founders</h1>
							<p class="center">
						...
						<div class="col-md-8">
							<div class="row">
								<ul class="team-list">
									<li class="col-md-4 ">
										<div class="thumbnail">
											<img src="assets/images/advait.jpg" alt="">
									...
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img src="assets/images/haresh.jpg" alt="">
											<span class="image-overlay"></span>
										</div>
										<h3>Haresh Moorjani</h3>
										<div>
											Founder & COO
										</div>
									...
									<li class="col-md-4 col-sm-6">
										<div class="thumbnail">
											<img src="assets/images/krishna.jpg" style="height: 223px;width: 230px" hieght="230px" width="230px" alt="">
											<span class="image-overlay"></span>
										</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="promobox">
								<p class="center">
									The Following are Co-founders of Vision Medicare.
								</p>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<ul class="team-list animate-group">
									<li class="col-md-2 col-sm-2">
										<div class="thumbnail">
											<img class="animate" src="assets/images/darshan.jpg" alt="" data-animation-options='{"animation":"fadeInRight", "duration":"300"}'>
											<span class="image-overlay"></span>
										</div>
										<h3>Darshan Shah</h3>
										<div>
									...
									<li class="col-md-2 col-sm-2">
										<div class="thumbnail">
											<img class="animate" src="assets/images/darpan.jpg" alt="" data-animation-options='{"animation":"fadeInLeft", "duration":"300"}'>
											<span class="image-overlay"></span>
										</div>
										<h3>Darpan Rajput</h3>
										<div>
									...
									<li class="col-md-2 col-sm-2">
										<div class="thumbnail">
											<img class="animate" src="assets/images/karan.jpg" alt="" data-animation-options='{"animation":"fadeInRight", "duration":"300"}'>
											<span class="image-overlay"></span>
										</div>
										<h3>Karan Patel</h3>
										<div>
									...
									<li class="col-md-2 col-sm-2">
										<div class="thumbnail">
											<img class="animate" src="assets/images/jitesh.jpg" alt="" data-animation-options='{"animation":"fadeInLeft", "duration":"300"}'>
											<span class="image-overlay"></span>
										</div>
										<h3>Jitesh Chavhan</h3>
										<div>
											Co Founder
										</div>
...
<!-- Mirrored from www.cliptheme.com/preview/frontend/clip-one/pages_team.jsp by HTTrack Website Copier/3.x [XR&CO'2010], Mon, 01 Sep 2014 10:04:46 GMT -->
</html>
