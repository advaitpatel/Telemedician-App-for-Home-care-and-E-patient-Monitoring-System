...
<div role="navigation" class="navbar navbar-default navbar-fixed-top space-top">
		...
		<section class="wrapper">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h3 class="text-primary" align="center">Please, Select Your area From Here to find near by Medical Labs.
						</h3>
						<div class="well well-lg col-md-12">
							<div class="col-sm-6">
								<form role="form" method="get" name="f7" class="horizontal-form margin-bottom-40" action="search_result_labs.jsp">
									...
									<div class="form-group">
										...
										<select class="form-control"  id="dropdown" name="area">
											...
											<option value="${row.area}" name="drname"><c:out value="${row.area }"></c:out></option>
											</c:forEach>
