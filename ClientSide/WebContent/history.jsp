	...
	<body>
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<sql:query dataSource="${cl_reg}" var="appoint">
								select * from appointment where patient='<%=ss%>';
							</sql:query>
							
							<sql:query dataSource="${cl_reg}" var="doct">
								select distinct(doctor) from history where p_user='<%=ss%>';
							</sql:query>
							
							
							<sql:query dataSource="${cl_reg}" var="store">
								select distinct(medical_store) from history where p_user='<%=ss%>';
							</sql:query>
							
							<sql:query dataSource="${cl_reg}" var="medicine">
								select distinct(medicine) from history where p_user='<%=ss%>';
							</sql:query>
							
							<sql:query dataSource="${cl_reg}" var="medical">
								select distinct(medical) from history where p_user='<%=ss%>';
							</sql:query>
							
							<sql:query dataSource="${cl_reg}" var="logout">
		...
		<div class="main-container">
			<section class="wrapper portfolio-page">
				<div class="container">
					<div class="controls">
						<h3><center> Here You can see Your Complete History</center></h3>
					...
					<ul id="Grid" class="list-unstyled">
						<li class="col-md-3 col-xs-12 mix category_1" data-cat="1">
							<div class="portfolio-item img-thumbnail">
								<a class="thumb-info" href="appointment_result.jsp">
									You &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
									have &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
									<c:out value="${appoint.rowCount }"></c:out>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
									appointment(s).&nbsp;&nbsp;

									<br><br><br><br><br>
									<span class="thumb-info-title"> <span class="thumb-info-inner"> Appointments </span></span>
								</a>
							</div>
						</li>
						<li class="col-md-3 col-xs-12 mix category_1" data-cat="1">
							<div class="portfolio-item img-thumbnail">
								<a class="thumb-info" href="doctor_result.jsp">
									You have <br>&nbsp;&nbsp;&nbsp;&nbsp;
									searched for<br>&nbsp;&nbsp;&nbsp;&nbsp;
									<c:out value="${doct.rowCount -1}"></c:out><br>&nbsp;&nbsp;&nbsp;&nbsp;
									doctors.<br><br><Br><br><br>
									<span class="thumb-info-title"> <span class="thumb-info-inner">Docters</span></span>
								</a>
							</div>
						</li>
						<li class="col-md-3 col-xs-12 mix category_1" data-cat="1">
							<div class="portfolio-item img-thumbnail">
								<a class="thumb-info" href="#">
									You have <br>&nbsp;&nbsp;&nbsp;&nbsp;
									searched for<br>&nbsp;&nbsp;&nbsp;&nbsp;
									<c:out value="${medicalstore.rowCount-1}"></c:out><br>&nbsp;&nbsp;&nbsp;&nbsp;
									medical stores.<br><br><Br><br><br>
									<span class="thumb-info-title"> <span class="thumb-info-inner">Medical stores</span></span>
							</a>
							</div>
						</li>
						...
						<li class="col-md-3 col-xs-12 mix category_1" data-cat="1">
							<div class="portfolio-item img-thumbnail">
								<a class="thumb-info" href="#">
									You have <br>&nbsp;&nbsp;&nbsp;&nbsp;
									inserted <br>&nbsp;&nbsp;&nbsp;&nbsp;
									<c:out value="${medicine.rowCount-1}"></c:out><br>&nbsp;&nbsp;&nbsp;&nbsp;
									medicines.<br><br><Br><br><br>
									<span class="thumb-info-title"> <span class="thumb-info-inner">Medicines</span></span>
								</a>
							</div>
						</li>
						<li class="col-md-3 col-xs-12 mix category_1" data-cat="1">
							<div class="portfolio-item img-thumbnail">
								<a class="thumb-info" href="#">
									You have <br>&nbsp;&nbsp;&nbsp;&nbsp;
									provided <br>&nbsp;&nbsp;&nbsp;&nbsp;
									<c:out value="${medical.rowCount-1}"></c:out><br>&nbsp;&nbsp;&nbsp;&nbsp;
									medical reports.<br><br><Br><br><br>
									<span class="thumb-info-title"> <span class="thumb-info-inner">Medical History</span></span>
							</a>
							</div>
						</li>
						...
						<li class="col-md-3 col-xs-12 mix category_1" data-cat="1">
							<div class="portfolio-item img-thumbnail">
								<a class="thumb-info" href="#">
									...
									You have <br>&nbsp;&nbsp;&nbsp;&nbsp;
									last logged on <br><br>
									<c:out value="${logout.rowsByIndex[0][0] }"></c:out>  <br>&nbsp;&nbsp;&nbsp;&nbsp;	
									</c:otherwise>
									
									
									</c:choose>
									<br><br><br><br>
									<span class="thumb-info-title"> <span class="thumb-info-inner">Last Login</span></span>
							</a>
							</div>
						</li>
